...
namespace easysql
{
    ...
    public class Restrain
    {
        ...
        public static Restrain Start(int start)
        {
            return new Restrain(null, new Object[] { start }, RestrainType.start);
        }
        public static Restrain MaxResult(int maxResult)
        {
            return new Restrain(null, new Object[] { maxResult }, RestrainType.maxResult);
        }

        public static Restrain Between(String key,object lo,object hi)
        {
            return new Restrain(key, new Object[] { key, hi }, RestrainType.between);
        }
